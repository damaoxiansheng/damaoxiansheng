...
path = os.path.abspath(os.path.dirname( os.path.dirname(__file__))) + r"\sjcf\mima_weikongsj.json"
...
class ds_zxdl(unittest.TestCase):
    ...
    def test_fxdl_01(self,d):
        ...
        yq = d["dy"]
        sj = self.driver.find_element(By.XPATH,'//*[@id="login-form"]/div/dl[2]/dd/span/font').text
