...
path = os.path.abspath(os.path.dirname( os.path.dirname(__file__))) + r"\sjcf\fanxiang_zhuce_youxiang.json"
...
class ds_zxdl(unittest.TestCase):
    ...
    def test_zxdl_01(self,d):
        ...
        #断言
        yq = d["dy"]
        sj = self.driver.find_element(By.XPATH,'//*[@id="register-form"]/div/dl[2]/dd/span/font').text
