...
class mailsend():
    def sendFujian(self,filename):
        ...
        username = "changpei12315@163.com"
        #大家自己的qq邮箱、163邮箱的授权码
        # 不是登录密码
        password = "OCAPHXSNQVKIVWUB"
        #设置发送邮箱，就是你的登录邮箱
        sender = "changpei12315@163.com"
        #设置接收邮箱
        # receiver = "2572652583@qq.com"
        ...
        path2 = os.path.abspath(os.path.dirname(os.path.abspath(os.path.dirname(__file__))))+r"/test_reports/"
        path = path2+filename+".html"
        # 获取的当前目录下的一个html文件的全路径
